...
const PendletonHall = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      <Typography>
        Day and Klauder, a firm behind many successful Collegiate Gothic designs
        for Cornell and Princeton, was commissioned in 1916 to design Pendleton
        Hall for Wellesley College [1]. Implementing their signature Collegiate
        Gothic style and adhering to a palette of red brick and cream limestone,
        Day and Klauder created an environment where prestige and tradition
        define the academic atmosphere.
      </Typography>
      <Typography>
        Pendleton is the final building constructed for the U-shaped plan
        encircling the top of Norumbega Hill. Composing the northern side of the
        quad, the building’s shallow V-shape directs students towards the
      ...
      <Typography>
        ...
        departments, Pendleton’s V-shaped layout intuitively divides it into two
        wings. Its levels are quite irregular, designed to conform to the
        ...
        trailblazer in the sciences, and careful consideration of the comfort of
        those who utilized the spaces.
      </Typography>
      <img src={Pendleton_front} alt="Pendleton Hall, as seen from the front" />
      <Typography className={classes.caption}>
        Jiang, Lily. April 2023. Pendleton at night. The shallow V-shape can be
        clearly seen, dividing the building into two wings: Pendleton West and
        Pendleton East (left and right, respectively).
      </Typography>
      ...
      <Typography>
        ...
        destroyed College Hall (and most of the physics equipment), the need for
        these academic buildings increased dramatically, furthering the plan
        [4]. As part of that plan, Pendleton Hall was intended to house the
        physics, chemistry, and psychology departments [5].
      </Typography>
      <Typography>
        The Farnsworth Green plan had the goal of creating an administrative and
        academic center on Norumbega Hill, moving it away from the original
        College Hall Hill [6]. As noted in the Inventory Form for the Academic
        Quad, many existing structures were demolished for this plan to come to
        fruition. In particular, the residential Freemam Hall and Wood Cottage
        were destroyed to make room for Pendleton Hall.
      </Typography>
      <Typography>
      ...
      <Typography>
        Pendleton Hall is named after Ellen Fitz Pendleton, Wellesley's beloved
        college president from 1911-1936 and an alum from the class of 1886. The
        building honors the sheer amount of energy and resources Pendleton
        poured into creating a beautiful and united campus [8].
      </Typography>
      <Typography className={classes.header1}>
        Pendleton’s Collegiate Gothic style reinforces the image of a scholarly
        institution.
      </Typography>
      <Typography>
        To create a cohesive, multi-purpose quad, it was necessary that all the
        buildings were designed in a style versatile enough to support their
        various uses. The Academic Quad Inventory Form deems Collegiate Gothic
        as "diverse and flexible," rendering it the perfect style for the quad.
        Collegiate Gothic also conveyed tradition and academia, and was thus
        chosen to express the cultural idea of a scholarly institute.
      </Typography>
      <Typography>
        Pendleton Hall in particular benefited from this style. The tall windows
        provided ample natural light for work performed in the lab spaces, while
        the spacious interiors allowed for placing partitions anywhere [9].
        Overall, Pendleton is a fantastic blend of form and function, providing
        a beautiful, versatile, and practical space for scientific pursuits.
      </Typography>
      <img
        src={Pendleton_side}
      ...
      />
      <Typography className={classes.caption}>
        Image from the Wellesley College Archives [10]. Pendleton West, as seen
        from the East side. The tall rectangular windows, in groups of 2-4, are
        one of the more prominent features of the building.
      </Typography>
      <Typography>
        Collegiate Gothic also supported irregular, spontaneous topography. This
        was a necessity since, as mentioned in the Academic Quad's Inventory
        Form, all of the buildings were situated on the brow of Norumbega Hill
        rather than the flat plateau. Carefully fitted to the contour of the
        hill, the north side of Pendleton is 3-4 floors while the south side is
        2-3 floors [11].
      </Typography>
      <Typography>
        The Inventory Form (for Pendleton Hall specifically) points out that as
        the last building within the quad to be constructed, Pendleton didn't
        recieve much budget. To cut costs down by almost half, Pendleton's
        exterior was designed with less ornamentation than other buildings
        within the quad. The windows are entirely rectangular, while other
        buildings also include arched and lancet-like windows. Pinnacles,
        tracery, and other decoration were removed from the building's final
        design, which is evident particularly when comparing it with Green Hall.
      </Typography>
      ...
      <Typography>
        ...
        the advice of Professor Voss at MIT (an expert in construction methods),
        Pendleton’s water-struck, body-red brick was chosen through a rigorous
        process. In a letter to President Pendleton, Voss specifically
        recommended testing over 100 bricks for an ideal absorption of 5% in 48
        hours.
      </Typography>
      <Typography>
        To complement the red brick, cream-colored Indiana limestone was chosen
        to complete the facade [14]. Pendleton’s copings, window surrounds,
        entrance surrounds, and various other trim all consist of this material.
      </Typography>
      <Typography>
        Overall, much emphasis was placed upon choosing the materials Pendleton
        was constructed from to ensure the building was durable and
      ...
      <Typography>
        Designed as an academic building, Pendleton’s interior was specifically
        curated to cater to Wellesley’s innovative academic program. The design
        also prioritized the comfort of the people utilizing the space.
        According to physics professor Louise McDowell's publication about
        Pendleton's physics facilities, planning Pendleton involved 3
        principles: convenience of arrangement, completeness of equipment, and
        comfort of the users [17].
      </Typography>
      <Typography>
        ...
        servicing all uses in all rooms, the physics department was well-suited
      ...
      <Typography>
        ...
        design is notable for prioritizing the human experience of being in the
        rooms. Some notable accomodations that McDowell notes are:
      </Typography>
      <Typography>
      ...
      <Typography>
        ...
        construction of the Science Center in 1977 resulted in the relocation of
        the physics and chemistry departments [19]. Replacing these vacancies
        were social sciences and humanities in Pendleton East, and various arts
        in Pendleton West. The original benefits of the Collegiate Gothic style
        for lab spaces applied easily to the new art studios, as the windows
        provide ample natural light and the ability to partition the space
        allowed for well-sized studios.
      </Typography>
      <Typography>
        ...
        floor-to-ceiling windows, exposed concrete walls, and wood accents. But
        most importantly, the addition involved a sky bridge connecting the arts
        of Pendleton West to the arts of Jewett, effectively unifying the two
        and pushing for overlaps in curriculum [21].
      </Typography>
      <Typography>
      ...
      <Typography className={classes.caption}>
        ...
        renovations. These closures are part of an effort to repair failing HVAC
        systems.
      </Typography>

      <Typography>
        Overall, Pendleton Hall is a remarkable example of how architecture can
        affect the academic experience by providing beautiful and functional
        spaces for learning, studies, and research. Despite originally being
        constructed with a limited budget, Pendleton remains well-maintained and
        visually impressive due to the sheer amount of careful planning that
        went into its design. And as a beautiful example of Collegiate Gothic
        architecture, Pendleton continues to uphold the distinguished academic
        environment of Wellesley College today as an arts, social sciences, and
      ...
      <Typography>
        6. Schuler, Gretchen. _Academic Quadrangle_. Inventory Form Continuation
        Sheet, page 4. Boston: Massachusetts Historical Commission, March 1989.
      ...
      <Typography>
        ...
        Newspaper. Wellesley: Office of Publicity, December 3, 1934. From
        Wellesley College Archives, Library and Technology Services, President's
        Office, Pendleton Hall (1934-38).
      </Typography>
      <Typography>
      ...
      <Typography>
        20. "Pendleton West Reopens as New Collaborative Arts Center." Spotlight
        on Wellesley. October 19, 2017. Accessed April 24, 2023.
